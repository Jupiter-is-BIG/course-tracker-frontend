...
{showModal && (
            ...
            {currentPage === 1 && (
              ...
              <h2 className="text-2xl font-bold mb-4">Important</h2>
                ...
                <div className="flex flex-row space-x-5 mt-6">
                  ...
                  <p className="text-gray-300 text-justify">We're excited to have you. Before registering an account, please join our discord server. This is crucial to ensure you receive notifications about course availability.</p>
                  <a href="https://discord.gg/295MtevYzQ" className="w-full flex justify-center mr-2 mt-10"> <div className="bg-discord p-2 rounded">Join Server</div></a>
                  </div>
                  <iframe src="https://discord.com/widget?id=1188065440820383744&theme=dark" title="discord-widget" width="300" height="350" allowtransparency="true" frameBorder="0" sandbox="allow-popups allow-popups-to-escape-sandbox allow-same-origin allow-scripts"></iframe>

                </div>
                
                  <button className="absolute right-0 bottom-0 text-white hover:text-black hover:bg-gray-300 transition duration-200 bg-discord p-1 rounded my-5 mx-8 px-4" onClick={goToNextPage}>
                    Next
                  </button>
            ...
            {currentPage === 2 && (
              ...
              <h2 className="text-2xl font-bold mb-4">Important</h2>
                ...
                <div className="flex flex-col mt-6 space-y-10">
                  <div className="flex flex-col justify-around">
                  <p className="text-gray-300 text-justify">To be able to recive notifcations about course availability, make sure Allow direct messages from server members is turned on in your <b>Discord {">"} User Settings {">"} Privacy & Safety</b></p>
                  </div>
                  ...
                  <button className="absolute left-0 bottom-0 text-white hover:text-black hover:bg-gray-300 transition duration-200 bg-discord p-1 rounded my-5 mx-8 px-4" onClick={goToPreviousPage}>
                    Previous
                  </button>
        ...
        {currentPage === 3 && (
              ...
              <h2 className="text-2xl font-bold mb-4">Important</h2>
                ...
                <div className="flex flex-col mt-1 space-y-2">
                  <div className="flex flex-col justify-around">
                  <p className="text-gray-300 text-justify">The sign up process requires your Discord ID. This is a public id linked with your discord username. To get your discord id, follow the steps mentioned in <a href="https://discord.com/channels/1188065440820383744/1190461384341852200/1190465831046500375" className="text-discord hover:text-indigo-300 hover:underline">user-id</a> channel on discord.</p>
                  </div>
                  <img src={useridPath} alt="Discord User ID" />

                </div>
                
                  <button className="absolute right-0 bottom-0 text-white hover:text-black hover:bg-gray-300 transition duration-200 bg-discord p-1 rounded my-5 mx-8 px-4" onClick={closeModal}>
                    Done
                  </button>
                  <button className="absolute left-0 bottom-0 text-white hover:text-black hover:bg-gray-300 transition duration-200 bg-discord p-1 rounded my-5 mx-8 px-4" onClick={goToPreviousPage}>
                    Previous
      ...
      <form className="max-w-sm mx-auto border border-white rounded p-5 w-[100%]">
        ...
        <div className="mb-5">
          <label htmlFor="discord" className="mb-2 text-sm font-medium text-gray-900 dark:text-white flex flex-row items-center space-x-2">
            <div>Discord User Id</div>
            <div onClick={() => {setShowModal(true); setCurrentPage(3);}} className="text-black flex justify-center items-center bg-gray-200 hover:bg-white transition duration-500 hover:opacity-100 opacity-50 w-5 h-5 rounded-full">?</div>
          </label>
